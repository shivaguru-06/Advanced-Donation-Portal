...
$sql = "INSERT INTO fund (name, email, phone ,donation_amount,payment_method,acknowledgement,preferred_date, preferred_time, preferred_address, message) VALUES ('$name', '$email', '$phone', '$donation_amount','$payment_method','$acknowledgement','$preferred_date','$preferred_time', '$preferred_address', '$message')";
