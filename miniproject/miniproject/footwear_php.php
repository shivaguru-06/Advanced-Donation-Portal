...
$footwear_type = $_POST['footwear_type'];
$size= $_POST['size'];
...
$sql = "INSERT INTO footwear (name, email, phone ,footwear_type,size,preferred_date, preferred_time, preferred_address, message) VALUES ('$name', '$email', '$phone', '$footwear_type','$size','$preferred_date','$preferred_time', '$preferred_address', '$message')";
